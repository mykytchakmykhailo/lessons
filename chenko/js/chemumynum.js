document.addEventListener('DOMContentLoaded', () => {
  const counters = [
    { elem: '.chemumy_2024', target: 150, year: '2023' },
    { elem: '.chemumy_2025', target: 250, year: '2024' }
  ];
  ...
  counters.forEach(counter => {
    ...
    el.innerHTML = `<div class="counter-number" id="counter-${counter.year}">0</div><div class="counter-text">Clients</div><div class="year-text">for ${counter.year}</div>`;
